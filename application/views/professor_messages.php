            ...
            <div class="col-md-6 portfolio-item" style="width:100%">
                ...
                <div class="box box-danger" style="position:relative">
                    <div class="announcement">
                        <p style="display:inline;"><small>from: </small><?=$message->name?><small style="font-size:10px"></small></p>
                        ...
                        <button class="btn btn-success" style="position:absolute; right:5px; font-size:12px" onclick="showMessaege('<?=$message->id?>')">Respond</button>
                    </div>
                </div>

                <div id="response<?=$message->id?>" style="position:relative; display:none">
                    <div class="row">
                        <form class="col-lg-6 text-center" style="margin-bottom: 5px" method="post">
                            ...
                            <input type="hidden" name="messageid" value="<?=$message->sender?>">
